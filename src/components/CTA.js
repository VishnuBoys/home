import puja from "../images/puja.jpg"
  ...
  export default function Example() {
    ...
    <div class="container px-6 py-10 mx-auto">
        <h1 className="text-4xl font-bold tracking-tight sm:text-center sm:text-6xl pb-20 text-amber-600">Recent Updates & Upcoming Events</h1>
        <div class="lg:flex lg:-mx-6">
            ...
            <div class="mt-8 lg:w-1/4 lg:mt-0 lg:px-6">
                <div>
                    <h3 class="text-amber-600 text-lg capitalize">Graduation Ceremony</h3>
                ...
                <div>
                    <h3 class="text-amber-600 text-lg capitalize">Puja & Divali Celebration</h3>
